		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Protif Phase 2",
									"targetURL": "#ProtifPhase2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProtifPhase2-display": {
								"semanticObject": "ProtifPhase2",
								"action": "display",
								"description": "Protif Phase2",
								"title": "Protif Phase 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pro.phase2.ZPRO_PROTIF2",
									"url": sap.ui.require.toUrl("com/pro/phase2/ZPRO_PROTIF2")
								}
							}
						}
					}
