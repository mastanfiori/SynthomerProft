...
sap.ui.define([
	...
	"com/pro/phase2/ZPRO_PROTIF2/test/flpSandbox"
	...
	return Opa5.extend("com.pro.phase2.ZPRO_PROTIF2.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZC_ProtifCreditView/" + encodeURIComponent(sObjectId);
